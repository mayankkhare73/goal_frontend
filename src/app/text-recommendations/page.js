                ...
                <div className="text-center">
                    ...
                    <p className="mt-4 text-[#00ffff] text-lg">
                        {loading && processingStage 
                            ? processingStage 
                            : 'Initializing your career narrative analysis...'}
                    </p>
                </div>
            </div>
        );
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                    <div>
                        ...
                        <p className="text-gray-300 mt-1">
                            Share your professional narrative and let our AI decode your ideal career path.
                        </p>
                    </div>
                ...
                <div className="bg-[#3a3a80]/70 backdrop-blur-lg rounded-xl shadow-lg p-6 border border-[#9370db]/20 mb-8">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-4">
                            ...
                            >
                                Express your skills, passions, experiences, and career aspirations in your own words
                            </label>
                            <textarea
                                id="userInput"
                                name="userInput"
                                ...
                                placeholder="For example: I thrive when solving complex problems and working with data visualization. With my mathematics background and growing interest in emerging technologies, I'm seeking a career path that combines analytical thinking with creative innovation in a collaborative environment."
                                value={textInput}
                                onChange={(e) => setTextInput(e.target.value)}
                                required
                            ></textarea>
                            <p className="text-xs text-gray-400 mt-2">
                                Minimum 50 characters. The more detailed your professional narrative, the more precise your career DNA mapping will be.
                            </p>
                        </div>

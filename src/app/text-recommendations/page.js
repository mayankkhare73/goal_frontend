                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full h-48 bg-gray-700/50 border border-cyan-500/20 rounded-lg px-4 py-3 text-gray-300 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent resize-none"
                    ...
                    <div className="bg-gray-800/50 backdrop-blur-lg rounded-xl shadow-lg p-8 border border-cyan-500/20">
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start">
                                ...
                                <span className="text-gray-300">Describe your skills, interests, and career goals</span>
                            </li>
                            <li className="flex items-start">
                                <span className="w-6 h-6 bg-cyan-500/20 text-cyan-400 rounded-full flex items-center justify-center text-sm font-semibold mr-3 mt-1">
                                    2
                                </span>
                                <span className="text-gray-300">Our AI analyzes your input using advanced algorithms</span>
                            </li>
                            <li className="flex items-start">
                                <span className="w-6 h-6 bg-cyan-500/20 text-cyan-400 rounded-full flex items-center justify-center text-sm font-semibold mr-3 mt-1">
                                    3
                                </span>
                                <span className="text-gray-300">Receive personalized career recommendations</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="bg-gray-800/50 backdrop-blur-lg rounded-xl shadow-lg p-8 border border-blue-500/20">
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start">
                                ...
                                <span className="text-gray-300">Be specific about your skills and experience</span>
                            </li>
                            <li className="flex items-start">
                                <span className="w-6 h-6 bg-blue-500/20 text-blue-400 rounded-full flex items-center justify-center text-sm font-semibold mr-3 mt-1">
                                    ✓
                                </span>
                                <span className="text-gray-300">Mention your preferred work environment</span>
                            </li>
                            <li className="flex items-start">
                                <span className="w-6 h-6 bg-blue-500/20 text-blue-400 rounded-full flex items-center justify-center text-sm font-semibold mr-3 mt-1">
                                    ✓
                                </span>
                                <span className="text-gray-300">Include your long-term career goals</span>
                            </li>
                        </ul>
                    </div>
                </div>

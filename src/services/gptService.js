...
export async function generateCareerRecommendations(quizResponses) {
  try {
    ...
    1. YOU MUST PROVIDE EXACTLY 3 COMPLETELY DIFFERENT AND VARIED PROFESSIONAL FIELDS AND CAREER PATHS (not just specific jobs) based strictly on the quiz responses
    ...
    12. Ensure the 3 recommendations span different sectors (e.g., one scientific/technical, one creative/artistic, one service/people-oriented)
...

    {
      "recommendations": [
        {
          "title": "Professional Field/Career Path 1",
          "match_score": 0.65-1.0,
          "sector": "Government/Private/Both",
          "detailed_analysis": {
            "personality_match": "Detailed explanation of how this professional field aligns with the user's personality traits",
            "interest_alignment": "How this career path matches the user's expressed interests",
            "skill_compatibility": "Analysis of how the user's current skills align with required skills in this field",
            "growth_potential": "Long-term career growth prospects and opportunities within this field",
            "work_life_balance": "Detailed analysis of work-life balance expectations in this professional domain",
            "job_satisfaction": "Factors that contribute to job satisfaction in this field",
            "stress_levels": "Typical stress levels and pressure points in this professional field",
            "learning_curve": "Expected learning curve and skill development timeline in this domain"
          },
          "career_guide": {
        ...
        {
          "title": "Professional Field/Career Path 2",
          "match_score": 0.65-1.0,
          "sector": "Government/Private/Both",
          "detailed_analysis": { ... },
          "career_guide": { ... },
        ...
        {
          "title": "Professional Field/Career Path 3",
          "match_score": 0.65-1.0,
          "sector": "Government/Private/Both",
          "detailed_analysis": { ... },
          "career_guide": { ... },
